...
const EditProfile = () => {
  ...
  const [firstName, setFirstName] = React.useState('Zalick');
  const [lastName, setLastName] = React.useState('Innopolis');
  const [nickName, setNickName] = React.useState('@zalick');
  const [email, setEmail] = React.useState('zalick@email.ru');
