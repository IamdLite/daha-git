...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://daha-471595.pages.pg.innopolis.university/"><strong>Visit Deployed Doc 🚀</strong></a>
    <br />
    <br />
...
![Context Diagram](images/ContextDiagram.png){: width="350px"}
</div>

The context diagram illustrates DAHA’s stakeholders and external systems. 📖 **Read more**: [docs/context-diagram.markdown](docs/context-diagram.markdown)
...
📖 **Read more**: [docs/project-description.markdown](docs/project-description.markdown)
...
📖 **Full Guide**: [docs/usage.markdown](docs/usage.markdown)
...
Set up DAHA locally with these steps. Detailed instructions in [docs/installation.markdown](docs/installation.markdown).
...
- 📊 [docs/quality-assurance/quality-assurance.markdown](docs/quality-assurance/quality-assurance.markdown)
- 🧪 [docs/quality-assurance/automated-tests.markdown](docs/quality-assurance/automated-tests.markdown)
- 👩‍💻 [docs/quality-assurance/user-acceptance-tests.markdown](docs/quality-assurance/user-acceptance-tests.markdown)
- 📏 [docs/quality-assurance/quality-attribute-scenarios.markdown](docs/quality-attributes/quality-attribute-scenarios.markdown)
...
- 🔄 [docs/automation/continuous-integration.markdown](docs/automation/continuous-integration.markdown)
- 🚀 [docs/automation/continuous-delivery.markdown](docs/automation/continuous-delivery.markdown)
...
A huge thank you to everyone who supported DAHA’s development:
